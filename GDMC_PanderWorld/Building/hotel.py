...
def hotel3(x,y,z):
    Firework_s(x-31,y+1,z-31,"dispenser","redstone_wire","redstone_block","slime_block","sticky_piston","daylight_detector","air","polished_andesite")
    fire(x-31,y+1,z-31)
